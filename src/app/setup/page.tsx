...
export default function SetupPage() {
  ...
  // OPML import state
  const [rssFeeds, setRssFeeds] = useState<Array<{id: string, feed_url: string}>>([]);
  ...
  // OPML preview: parse and show selectable list (filter out already registered feeds)
  async function handleOPMLPreview(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      // Filter out already registered feeds
    ...
    <div className="min-h-screen bg-orange-500 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="bg-orange-50 border border-orange-200 rounded-md p-4 mb-5">
          <h3 className="text-sm font-medium text-orange-800 mb-3">RSSフィード追加</h3>
        ...
        <div className="bg-orange-50 border border-orange-200 rounded-md p-4 mb-5">
          ...
          <input
            ...
            className="block w-full text-sm text-gray-500 file:mr-6 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-orange-500 file:text-white hover:file:bg-orange-600 file:transition-colors"
          />
